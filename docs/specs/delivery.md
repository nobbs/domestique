...
| `ui-storybook-build` | Builds the static Storybook the sweep opens and Chromatic publishes. |
| `ui-storybook-sweep` | Opens every story and docs page in that built Storybook, through a few tabs of that same browser. |

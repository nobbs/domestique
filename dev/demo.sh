...
# with one exception: the planner routes through the public BRouter instance.
#
...
#   * A planner preview or save sends the waypoint coordinates and the profile
#     name to https://brouter.de, and nothing else: no session, no route name,
#     no library data. Without a network the planner reports a routing failure

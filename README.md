...
the readiness probe's own `127.0.0.1:8081`, while a TLS-terminating reverse
proxy alongside it in the compose project — Traefik is the documented example —
forwards the served listener

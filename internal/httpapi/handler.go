...
func (h *Handler) routes() {
	...
	h.mux.HandleFunc("GET /v1/activities", h.GetActivities)
	h.mux.HandleFunc("GET /v1/activities/fitness", h.GetFitness)
	h.mux.HandleFunc("GET /v1/activities/{activityId}/track", h.GetActivityTrack)
	h.mux.HandleFunc("POST /v1/activities/{activityId}/reanalyse", h.adminOnly(h.ReanalyseActivity))
	...
	h.mux.HandleFunc("PUT /v1/settings/rider/credentials/wahoo", h.SetRiderWahooCredentials)
	h.mux.HandleFunc("DELETE /v1/settings/rider/credentials/wahoo", h.DeleteRiderWahooCredentials)

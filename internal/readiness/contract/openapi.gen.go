...
type ActivityMetrics struct {
	...
	EstimatedPowerWatts *float64 `json:"estimatedPowerWatts,omitempty"`
	// EstimatedPedallingShare The share of the ride's samples the rider was pedalling through, which the estimate is averaged over. Present exactly when estimatedPowerWatts is.

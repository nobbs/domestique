...
INSERT INTO sync_schedule (id, source_enabled, targets_enabled, updated_at_unix) VALUES (1, 1, 1, 0);
...
INSERT INTO runtime_settings (
  id, allow_empty_source_deletion, stale_after_seconds, notifications_enabled, success_policy,
  digest_interval_seconds, pushover_base_url, surface_rebuild_interval_seconds, updated_at_unix
...
VALUES (0, 'Streets', 'https://tiles.openfreemap.org/styles/bright', 'https://tiles.openfreemap.org/styles/dark', 0);
...
VALUES ('sync:source', 1, 0), ('sync:target', 1, 0);
...
SELECT version, CAST(strftime('%s', 'now') AS INTEGER) FROM versions;

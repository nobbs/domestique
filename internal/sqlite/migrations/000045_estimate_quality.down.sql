...
CREATE TABLE activity_metrics_pre_quality (
...
INSERT INTO activity_metrics_pre_quality
SELECT target_slot, workout_id, zone_1_seconds, zone_2_seconds, zone_3_seconds, zone_4_seconds,
  ...
  estimated_power_watts, average_heart_rate_bpm, max_heart_rate_bpm, average_cadence_rpm,
...
ALTER TABLE activity_metrics_pre_quality RENAME TO activity_metrics;

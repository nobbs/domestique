...
CREATE TABLE activity_metrics_pre_max_speed (
...
INSERT INTO activity_metrics_pre_max_speed
SELECT target_slot, workout_id, zone_1_seconds, zone_2_seconds, zone_3_seconds, zone_4_seconds, zone_5_seconds, trimp, heart_rate_tss, normalized_power_watts, intensity_factor, power_tss, estimated_power_watts, estimate_autocorrelation, estimate_delta_watts_per_second, estimate_clip_bias_watts, average_heart_rate_bpm, max_heart_rate_bpm, average_cadence_rpm, average_power_watts, decoupling_percent, heat_drift_heart_rate_bpm, heat_drift_temperature_celsius, heat_drift_samples, best_power_5s, best_power_30s, best_power_60s, best_power_300s, best_power_1200s, best_power_3600s, input_max_heart_rate, input_resting_heart_rate, input_threshold_heart_rate, input_threshold_power, input_total_mass, derivation_version, computed_at_unix
FROM activity_metrics;
DROP TABLE activity_metrics;
ALTER TABLE activity_metrics_pre_max_speed RENAME TO activity_metrics;

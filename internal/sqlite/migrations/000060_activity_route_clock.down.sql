...
CREATE TABLE activity_route_match_pre_route_clock (
...
INSERT INTO activity_route_match_pre_route_clock (target_slot, workout_id, provider, route_id, stage_order, route_coverage, ride_coverage, direction, library_hash, matched_at_unix)
SELECT target_slot, workout_id, provider, route_id, stage_order, route_coverage, ride_coverage, direction, library_hash, matched_at_unix FROM activity_route_match;
DROP INDEX IF EXISTS activity_route_match_route_index;
DROP TABLE activity_route_match;
ALTER TABLE activity_route_match_pre_route_clock RENAME TO activity_route_match;

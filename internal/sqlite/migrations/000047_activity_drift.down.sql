...
CREATE TABLE activity_metrics_pre_drift (
...
INSERT INTO activity_metrics_pre_drift
SELECT target_slot, workout_id, zone_1_seconds, zone_2_seconds, zone_3_seconds, zone_4_seconds,
  ...
  estimated_power_watts, estimate_autocorrelation, estimate_delta_watts_per_second,
  estimate_clip_bias_watts, average_heart_rate_bpm, max_heart_rate_bpm, average_cadence_rpm,
  average_power_watts, input_max_heart_rate, input_resting_heart_rate, input_threshold_heart_rate,
  input_threshold_power, input_total_mass, derivation_version, computed_at_unix
FROM activity_metrics;
DROP TABLE activity_metrics;
ALTER TABLE activity_metrics_pre_drift RENAME TO activity_metrics;

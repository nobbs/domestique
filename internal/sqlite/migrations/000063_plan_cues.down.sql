...
INSERT INTO plans_pre_cues (id, name, profile, waypoints, coordinates, distance_metres, ascent_metres,
...
SELECT id, name, profile, waypoints, coordinates, distance_metres, ascent_metres,
  published, version, created_at_unix_nano, updated_at_unix_nano, pushing FROM plans;
DROP TABLE plans;
ALTER TABLE plans_pre_cues RENAME TO plans;

...
/** One band's stretches, split by whether the chart is showing them. */
...
/**
 * The route's steepness as lines to paint, grouped by band and split by the
 * stretch the chart is showing.
 *

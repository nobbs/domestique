    ...
    >
      ...
      >
        <div className="flex shrink-0 flex-col border-r border-[var(--rule)] pr-2">
          <Tabs.List className="flex flex-col gap-[3px] rounded-lg bg-[var(--muted)] p-[3px]">

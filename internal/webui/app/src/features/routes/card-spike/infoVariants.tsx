/**
 * Four takes on the route card in the design sample's idiom: a dark icon square naming
...
/** The design sample's card header: icon square, title, muted subtitle, actions at the end. */

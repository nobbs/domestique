/**
 * **D — Columns.** The shortest card, because height is what the pill bought.
 *
 * The other three read down the page, which is the direction the panel cannot
 * afford: it stands on a map, and every row it adds is a row of terrain the
 * reader came to look at. So this turns the card ninety degrees — figures in a
 * block on the left, both mixes as upright bars on the right — and comes out
 * around a third the height of the ledger for the same content.
 *
 * The bars are read like a cross-section: the ground that decides the day at
 * the top, the easy majority settling at the bottom. Labels sit beside their
 * own segment rather than in a row underneath, so nothing has to be matched by
 * colour — the name is at the height of the thing it names.
 *

...
import { BandsEffort, ColumnsEffort, RingEffort, RowsEffort, SeriesEffort } from "./effortVariants";
...
/** All five side by side, for comparison. */
export const All: Story = {
  render: () => (
    <div className="grid min-h-dvh grid-cols-[repeat(auto-fill,minmax(32rem,1fr))] gap-6 bg-[var(--base)] p-6">
      {[RowsEffort, ColumnsEffort, BandsEffort, RingEffort, SeriesEffort].map((Variant) => (

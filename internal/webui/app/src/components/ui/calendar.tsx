...
function CalendarDayButton({
  ...
  locale,
  ...props
  // `| undefined` spelled out: this project compiles with
  // `exactOptionalPropertyTypes`, under which an optional property and one
  // that may be undefined are different types, and the generated component
  // passes `locale` straight through whether or not it has one.
